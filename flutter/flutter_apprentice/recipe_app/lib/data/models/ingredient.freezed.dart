...
mixin _$Ingredient {
 ...
 int? get id; int? get recipeId; String? get name; double? get amount; double? get weight;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,recipeId,name,amount,weight);
...
/// Create a copy of Ingredient
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? recipeId = freezed,Object? name = freezed,Object? amount = freezed,Object? weight = freezed,}) {
...
class _Ingredient implements Ingredient {
  const _Ingredient({this.id, this.recipeId, this.name, this.amount, this.weight});
...
/// Create a copy of Ingredient
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? recipeId = freezed,Object? name = freezed,Object? amount = freezed,Object? weight = freezed,}) {
